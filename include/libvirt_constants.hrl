...
-define(VIR_CONNECT_BASELINE_CPU_MIGRATABLE,(1 bsl 1)).
...
-define(VIR_DOMAIN_PASSWORD_ENCRYPTED,1 bsl 0).
...
-define(VIR_STORAGE_POOL_CREATE_WITH_BUILD,1 bsl 0).
-define(VIR_STORAGE_POOL_CREATE_WITH_BUILD_NO_OVERWRITE,1 bsl 2).
-define(VIR_STORAGE_POOL_CREATE_WITH_BUILD_OVERWRITE,1 bsl 1).
...
-define(VIR_STORAGE_VOL_DELETE_WITH_SNAPSHOTS,1 bsl 1).
