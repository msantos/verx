        ...
        case _3 of
            ...
            74 ->
                {'REMOTE_PROC_CONNECT_LIST_DEFINED_STORAGE_POOLS',
                 _2 + 4};
            75 ->
                {'REMOTE_PROC_CONNECT_FIND_STORAGE_POOL_SOURCES',_2 + 4};
            76 ->
            ...
            137 ->
                {'REMOTE_PROC_CONNECT_NUM_OF_DEFINED_INTERFACES',_2 + 4};
            138 ->
            ...
            167 ->
                {'REMOTE_PROC_CONNECT_DOMAIN_EVENT_REGISTER_ANY',_2 + 4};
            168 ->
                {'REMOTE_PROC_CONNECT_DOMAIN_EVENT_DEREGISTER_ANY',
                 _2 + 4};
            169 ->
            ...
            327 ->
                {'REMOTE_PROC_DOMAIN_EVENT_CALLBACK_DISK_CHANGE',_2 + 4};
            328 ->
                {'REMOTE_PROC_DOMAIN_EVENT_CALLBACK_TRAY_CHANGE',_2 + 4};
            329 ->
            ...
            361 ->
                {'REMOTE_PROC_CONNECT_UNREGISTER_CLOSE_CALLBACK',_2 + 4};
            362 ->
            ...
            379 ->
                {'REMOTE_PROC_DOMAIN_EVENT_CALLBACK_METADATA_CHANGE',
                 _2 + 4};
            380 ->
                {'REMOTE_PROC_CONNECT_SECRET_EVENT_REGISTER_ANY',_2 + 4};
            381 ->
                {'REMOTE_PROC_CONNECT_SECRET_EVENT_DEREGISTER_ANY',
                 _2 + 4};
            382 ->
